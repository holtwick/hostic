...
describe('CSS', () => {
  ...
  it('should parse', () => {
    let element = <div id="foo" className="foo bar" foo="bar" data-lang="en">...</div>
  ...
  it('should specific meta', () => {
    let element = <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    expect(matchSelector('meta[name=viewport]', element)).toBe(true)

    element = <meta name="xviewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
  ...
  it('should query meta', () => {
    ...
    document.head.replaceWith(
      <head>
        ...
        <link rel="alternate" hrefLang="x-default" href="https://pdfify.app/help"/>
        <meta property="og:title" content="Help"/>
        <meta name="description" property="og:description" content="Online help of PDFify help"/>
        <meta name="keywords" property="og:keywords" content="help, doc, documentation, collect, app, macos, ios"/>
        <meta name="twitter:site" content="@holtwick"/>
        <meta name="twitter:creator" content="@holtwick"/>
        <meta name="twitter:card" content="summary"/>
        <meta name="generator" content="Hostic, https://github.com/holtwick/hostic/"/>
        <meta property="og:type" content="text/html"/>
        <meta charSet="utf-8"/>
        <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
        <link media="all" rel="stylesheet" href="/assets/bootstrap.min-cd5525bc.css"/>
        <link media="all" rel="stylesheet" href="/assets/custom-06a1f2ce.css"/>
        <link rel="shortcut icon" href="/assets/favicon-1268689e.png" type="image/png"/>
        <link rel="icon" type="image/png" href="/assets/favicon-32-3192cb36.png" sizes="32x32"/>
        <link rel="icon" type="image/png" href="/assets/favicon-96-b036137d.png" sizes="96x96"/>
        <link rel="apple-touch-icon" href="/assets/apple-touch-icon-2ac9c5f9.png"/>
        <link rel="apple-touch-icon" sizes="144x144" href="/assets/apple-touch-icon-2ac9c5f9.png"/>
